  ...
  return (
    <div className={styles.container}>
        ...
        <div className={styles.bottom}>
            ...
            <p className={styles.desc}>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sit laudantium hic officiis omnis, eligendi atque consequuntur inventore non soluta earum ex commodi tenetur. Fugit suscipit, incidunt debitis rem expedita voluptate.</p>
